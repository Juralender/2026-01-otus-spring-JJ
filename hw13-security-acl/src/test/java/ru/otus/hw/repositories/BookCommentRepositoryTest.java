...
class BookCommentRepositoryTest {
    ...
    void shouldReturnCorrectCommentById() {
        ...
        var user = testEntityManager.find(User.class, 1L);
        var comment = testEntityManager.persistAndFlush(new BookComment("Comment_1", book, user));
    ...
    void shouldReturnAllCommentsForBook() {
        ...
        var user = testEntityManager.find(User.class, 1L);
        testEntityManager.persistAndFlush(new BookComment("Comment_1_1", book1, user));
        testEntityManager.persistAndFlush(new BookComment("Comment_1_2", book1, user));
        testEntityManager.persistAndFlush(new BookComment("Comment_2_1", book2, user));
    ...
    void shouldSaveNewComment() {
        var book = testEntityManager.find(Book.class, 1L);
        var user = testEntityManager.find(User.class, 1L);
        var newComment = new BookComment("New comment", book, user);
    ...
    void shouldSaveUpdatedComment() {
        var book = testEntityManager.find(Book.class, 1L);
        var user = testEntityManager.find(User.class, 1L);
        var comment = testEntityManager.persistAndFlush(new BookComment("Old text", book, user));
        var updatedComment = new BookComment(comment.getId(), "New text", book, user);
    ...
    void shouldDeleteComment() {
        var book = testEntityManager.find(Book.class, 1L);
        var user = testEntityManager.find(User.class, 1L);
        var comment = testEntityManager.persistAndFlush(new BookComment("To delete", book, user));
