...
public class BookCommentRestController {
    ...
    public BookCommentDto update(@PathVariable long bookId, @PathVariable long commentId,
            @Valid @RequestBody BookCommentUpdateDto request) {
        return bookCommentService.update(new BookCommentUpdateDto(commentId, request.getText()));
    }
